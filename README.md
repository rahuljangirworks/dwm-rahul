<div align="center">
  ...
  # dwm-rahul
  ### A personal fork of [dwm-rahul](https://github.com/ChrisTitusTech/dwm-rahul), an extremely ***fast***, ***small***, and ***dynamic*** window manager for X.

</div>

---

> **Fork:** [rahuljangirworks/dwm-rahul](https://github.com/rahuljangirworks/dwm-rahul)
> **Upstream:** [ChrisTitusTech/dwm-rahul](https://github.com/ChrisTitusTech/dwm-rahul)

This is my personal fork of dwm-rahul. It is based on the original [suckless.org](https://dwm.suckless.org/) dwm window manager with patches and customizations for a user-friendly experience out of the box.
